...
summ.df.mean <- function(d) {
  splits <- rollapply(1:nrow(d), 15*100, function(x) x )
...
save(brushing.fingerprint, file = "brushing.fingerprint15s.RDA" )
save(brushing.fingerprint.sd, file = "brushing.fingerprint.sd15s.RDA" )
